...
public class Storymae_circle : MonoBehaviour
{
	...
	{
		// 配列作成
		CircleArray = new GameObject[7];
		ImgArray = new Image[7];

		// オブジェクト・コンポーネント取得
		CircleArray = GameObject.FindGameObjectsWithTag("Story_circle");
		int i = 0;
		...
		// 子オブジェクトの座標初期化
		CircleArray[0].transform.localPosition = new Vector3(-3.0f * fCircleInterval, 0.0f, 0.0f);
		CircleArray[1].transform.localPosition = new Vector3(-2.0f * fCircleInterval, 0.0f, 0.0f);
		CircleArray[2].transform.localPosition = new Vector3(-1.0f * fCircleInterval, 0.0f, 0.0f);
		CircleArray[3].transform.localPosition = new Vector3(0.0f * fCircleInterval, 0.0f, 0.0f);
		CircleArray[4].transform.localPosition = new Vector3(1.0f * fCircleInterval, 0.0f, 0.0f);
		CircleArray[5].transform.localPosition = new Vector3(2.0f * fCircleInterval, 0.0f, 0.0f);
		CircleArray[6].transform.localPosition = new Vector3(3.0f * fCircleInterval, 0.0f, 0.0f);
		...
		ImgArray[5].sprite = Sprite.Create(NonActiveCircle, new Rect(0, 0, NonActiveCircle.width,
																	  NonActiveCircle.height), Vector2.zero);
		ImgArray[6].sprite = Sprite.Create(NonActiveCircle, new Rect(0, 0, NonActiveCircle.width,
																	  NonActiveCircle.height), Vector2.zero);
